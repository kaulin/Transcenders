  ...
  return (
    <div className="flex flex-col w-full">
      {[
        ...
        <div
          key={i}
          className="flex flex-col mt-6 sm:mt-0 sm:flex-row w-full items-center justify-between text-md"
        >
          <div className="flex flex-col items-center sm:items-start">
            <div className="text-white text-center sm:text-xl font-fascinate uppercase">
              {title}
            </div>
