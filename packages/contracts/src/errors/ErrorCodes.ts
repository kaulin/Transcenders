...
export const ERROR_CODES = {
  ...
  COMMON: {
    ...
    NO_REFRESH_TOKEN: 'COMMON_NO_REFRESH_TOKEN',

    // Authentication plugin errors
    AUTH_TOKEN_REQUIRED: 'COMMON_AUTH_TOKEN_REQUIRED',
    AUTH_TOKEN_INVALID: 'COMMON_AUTH_TOKEN_INVALID',
    AUTH_MISSING_PARAMETER: 'COMMON_AUTH_MISSING_PARAMETER',
    AUTH_OWNERSHIP_REQUIRED: 'COMMON_AUTH_OWNERSHIP_REQUIRED',
    AUTH_STEPUP_REQUIRED: 'COMMON_AUTH_STEPUP_REQUIRED',
    AUTH_BYPASS_REQUIRED: 'COMMON_AUTH_BYPASS_REQUIRED',
    AUTH_SESSION_INVALID: 'COMMON_AUTH_SESSION_INVALID', // Forces re-login due to security events
  },
  ...
  AUTH: {
    ...
    COOKIE_ERROR: 'AUTH_COOKIE_ERROR',
    TWO_FACTOR_WRONG_CODE: 'AUTH_TWO_FACTOR_WRONG_CODE',
    TWO_FACTOR_NO_CHALLENGE: 'AUTH_TWO_FACTOR_NO_CHALLENGE',
    TWO_FACTOR_CHALLENGE_EXPIRED: 'AUTH_TWO_FACTOR_CHALLENGE_EXPIRED',
    TWO_FACTOR_CHALLENGE_CONSUMED: 'AUTH_TWO_FACTOR_CHALLENGE_CONSUMED',
    TWO_FACTOR_ALREADY_VERIFIED: 'AUTH_TWO_FACTOR_ALREADY_VERIFIED',
    TWO_FACTOR_NOT_ENABLED: 'AUTH_TWO_FACTOR_NOT_ENABLED',
    TWO_FACTOR_ENROLL_REQUIRED: 'AUTH_TWO_FACTOR_ENROLL_REQUIRED',
    TWO_FACTOR_CODE_SENT: 'AUTH_TWO_FACTOR_CODE_SENT',
    TWO_FACTOR_EMAIL_SENDING_FAILED: 'AUTH_TWO_FACTOR_EMAIL_SENDING_FAILED',
  },
  ...
  SCORE: {
    ...
    DUPLICATE_PLAYER_ID: 'SCORE_DUPLICATE_PLAYER_ID',
    INVALID_SCORE_VALUE: 'SCORE_INVALID_SCORE_VALUE',
    INVALID_DURATION_VALUE: 'SCORE_INVALID_DURATION_VALUE',
    INVALID_TIMESTAMP_VALUE: 'SCORE_INVALID_TIMESTAMP_VALUE',
    INVALID_TOURNAMENT_LEVEL: 'SCORE_INVALID_TOURNAMENT_LEVEL',
    INVALID_TIME_VALUE: 'SCORE_INVALID_TIME_VALUE',
    DUPLICATE_SCORE_ENTRY: 'SCORE_DUPLICATE_SCORE_ENTRY',
    INVALID_MATCH_ID: 'SCORE_INVALID_MATCH_ID',
    SUSPICIOUS_TIME_VALUE: 'SCORE_SUSPICIOS_TIME_VALUE',
    SCORE_MATCH_DISCREPANCY: 'SCORE_SCORE_MATCH_DISCREPANCY',
    STATS_CALCULATION_FAILED: 'SCORE_STATS_CALCULATION_FAILED',
    SCORE_NOT_FOUND: 'SCORE_SCORE_NOT_FOUND',
